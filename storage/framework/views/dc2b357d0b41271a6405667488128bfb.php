<?php $__env->startSection('content'); ?>
    ...
    <div data-tab-panel="ai" class="hidden">
        ...
        <div id="scan-upload-section">
            <form method="POST" action="<?php echo e(route('books.import.ai-batch-scan')); ?>" enctype="multipart/form-data" class="space-y-5" id="batch-scan-form" data-status-url-template="<?php echo e(route('books.import.ai-batch-status', ['token' => '__TOKEN__'])); ?>" data-cancel-url-template="<?php echo e(route('books.import.ai-batch-cancel', ['token' => '__TOKEN__'])); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <div data-tab-panel="grouping" class="hidden">
        <div class="rounded-[1.4rem] border border-gray-200 bg-white p-6">
            ...
            <?php else: ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $groupedInbox; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat => $books): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="rounded-2xl border border-gray-100 bg-gray-50 p-4">
                            <div class="mb-3 flex items-center justify-between">
                                <h3 class="text-sm font-bold text-gray-800"><?php echo e($cat ?: "Tanpa Kategori"); ?> <span class="text-xs font-normal text-gray-400">(<?php echo e($books->count()); ?> buku)</span></h3>
                            ...
                            <div class="grid gap-2 md:grid-cols-2">
                                <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3 rounded-lg bg-white p-3 text-sm">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate font-medium"><?php echo e($book->title); ?></p>
                                            <p class="text-xs text-gray-400"><?php echo e($book->author); ?> &middot; <?php echo e($book->isbn); ?></p>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
    ...
    <div data-tab-panel="routing" class="hidden">
        <div class="rounded-[1.4rem] border border-gray-200 bg-white p-6">
            ...
            <?php else: ?>
                <form method="POST" action="<?php echo e(route("books.import.route-books")); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $routableBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="p-3"><input type="checkbox" name="book_ids[]" value="<?php echo e($book->id); ?>" class="routing-checkbox rounded"></td>
                                        <td class="p-3">
                                            <p class="font-medium text-gray-900"><?php echo e($book->title); ?></p>
                                            <p class="text-xs text-gray-400"><?php echo e($book->author); ?></p>
                                        </td>
                                        <td class="p-3"><span class="rounded-full bg-gray-100 px-2 py-1 text-xs"><?php echo e($book->category ?: "-"); ?></span></td>
                                        <td class="p-3">
                                            <select name="rack_ids[<?php echo e($book->id); ?>]" class="form-input w-40 text-sm">
                                                <option value="">-- Pilih Rak --</option>
                                                <?php $__currentLoopData = $allRacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rack): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($rack->id); ?>"><?php echo e($rack->name); ?> <?php if($rack->room): ?> (<?php echo e($rack->room->name); ?>) <?php endif; ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </td>
                                        <td class="p-3">
                                            <input type="text" name="position_codes[<?php echo e($book->id); ?>]" class="form-input w-24 text-sm" placeholder="A1-01">
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
            ...
            <div class="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                <p class="text-sm font-semibold text-emerald-800">
                    ?? Sudah Di-route Hari Ini: <strong><?php echo e($routedToday); ?></strong> buku
                </p>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        (() => {
            ...
            const autoTab = <?php echo json_encode($groupedDraftBooks->isNotEmpty() && $aiDraftFinished ? 'review' : 'ai', 15, 512) ?>;
            setTopTab(autoTab);
        ...
        (() => {
            ...
            const lookupUrl = <?php echo json_encode(route('books.import.isbn-lookup'), 15, 512) ?>;
            let fetchCount = 0;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\renre\Downloads\Smart_LMS\resources\views/books/import.blade.php ENDPATH**/ ?>