...
<?php $component->withAttributes(['class' => 'mb-6']); ?>
        <form method="GET" action="<?php echo e(route('qr.generate')); ?>" class="flex flex-wrap gap-2">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit']); ?>Generate QR <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <a href="<?php echo e(route('qr.print', ['rack_id' => $selected_rack_id])); ?>" class="rounded-md border border-gray-300 px-4 py-2 text-sm text-slate-700 hover:bg-gray-100">Print Layout</a>
        </form>
...
<?php $component->withAttributes(['class' => 'text-center']); ?>
                <img src="<?php echo e($book->qr_code_path); ?>" alt="QR <?php echo e($book->title); ?>" class="mx-auto mb-2 h-28 w-28 object-contain">
                <p class="text-xs font-semibold text-slate-800"><?php echo e($book->title); ?></p>
