...
<?php $component->withAttributes(['class' => 'mb-6 shadow-md']); ?>
        ...
        <div class="inline-block rounded-xl border border-gray-200 p-4 shadow-sm bg-white overflow-x-auto max-w-full">
            ...
            <div class="mb-2 flex items-center gap-3">
                <div class="w-8"></div>
                <div class="grid gap-2 flex-1 min-w-max" <?php echo 'style="grid-template-columns: repeat(' . $rack->columns . ', 1fr);"'; ?>>
                ...
                <?php $__currentLoopData = $grid_matrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-3">
                        ...
                        <?php $__currentLoopData = $row['cells']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <button
                                type="button"
                                title="<?php echo e($canAssign ? 'Klik untuk assign buku' : ($cellTitles ?: 'Slot penuh')); ?>"
                                data-grid-cell
                                ...
                                <?php if($canAssign): ?> data-slot-button <?php else: ?> data-filled-cell <?php endif; ?>
                                class="<?php echo e($canAssign
                            ...
                            >
                                <div class="font-bold border-b <?php echo e($canAssign ? 'border-gray-200' : 'border-primary-200'); ?> w-full pb-0.5 mb-0.5"><?php echo e($cell['code']); ?></div>
                                <div class="text-[10px] font-semibold"><?php echo e($cell['count']); ?>/<?php echo e($cell['capacity']); ?></div>
                                <?php if($cell['count'] > 0): ?>
                                    <div class="mt-1 flex w-full flex-col gap-0.5 <?php echo e($canAssign ? 'pointer-events-none' : ''); ?>">
                                        <?php $__currentLoopData = array_slice($cell['books'], 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="truncate rounded px-1 py-0.5 text-[8px] <?php echo e($canAssign ? 'bg-white/70' : 'bg-white/50'); ?> w-full"><?php echo e($b['title']); ?></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($cell['count'] > 3): ?>
                                            <div class="text-[8px] <?php echo e($canAssign ? 'text-primary-700' : 'text-primary-800'); ?>">+<?php echo e($cell['count'] - 3); ?> buku lainnya</div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
...
<?php $component->withAttributes(['class' => 'mb-6 shadow-md']); ?>
        ...
        <form id="quick-move-form" class="grid grid-cols-1 gap-3 md:grid-cols-3">
            ...
            <select id="move-position-code" class="form-input">
                ...
                <?php $__currentLoopData = $available_positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <form action="<?php echo e(route('racks.update', $rack)); ?>" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input name="capacity_per_slot" type="number" min="1" max="100" value="<?php echo e($rack->capacity_per_slot ?? 50); ?>" class="form-input" required>
                    </div>
                    <div>
