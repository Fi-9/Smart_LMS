<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-6 grid gap-4 xl:grid-cols-4">
        <div class="rounded-[1.25rem] border border-gray-200 bg-white p-5">
            ...
            <h3 class="mt-2 text-lg font-bold text-gray-900"><?php echo e(strtoupper($ai_diagnostics['n8n']['status'] ?? 'unknown')); ?></h3>
            <p class="mt-2 text-sm text-gray-600"><?php echo e($ai_diagnostics['n8n']['detail'] ?? ''); ?></p>
            <p class="mt-2 text-xs text-gray-500"><?php echo e($ai_diagnostics['n8n']['endpoint'] ?? '-'); ?></p>
        </div>
        <div class="rounded-[1.25rem] border border-gray-200 bg-white p-5">
            ...
            <section class="rounded-[1.5rem] border border-gray-200 bg-white p-6">
                ...
                <div class="mt-5 grid gap-4">
                    <div>
                        ...
                        <input type="text" name="n8n_base_url" value="<?php echo e(old('n8n_base_url', $settings['n8n_base_url'])); ?>" class="form-input" placeholder="http://localhost:5678">
                    </div>
                    <div>
                        <label class="form-label">n8n API Key (JWT Token)</label>
                        <input type="password" name="n8n_api_key" value="<?php echo e(old('n8n_api_key', $settings['n8n_api_key'])); ?>" class="form-input" placeholder="<?php echo e($masked_settings['n8n_api_key'] ?? 'eyJh...'); ?>">
            ...
            <div class="mt-5">
                ...
                <div class="mt-2 flex items-center gap-4">
                    <?php if($school_logo_path): ?>
                        <img src="<?php echo e(Storage::url($school_logo_path)); ?>" alt="School Logo" class="h-16 w-16 object-contain rounded border bg-gray-50 p-1">
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\renre\Downloads\Smart_LMS\resources\views/settings/index.blade.php ENDPATH**/ ?>