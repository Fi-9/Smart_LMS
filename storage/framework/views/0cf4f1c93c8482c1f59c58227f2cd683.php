...
<?php $component->withAttributes(['class' => 'shadow-md transition-shadow hover:shadow-lg']); ?>
                    ...
                    <div class="grid gap-2 mb-3 max-w-full overflow-x-auto pb-2" <?php echo 'style="grid-template-columns: repeat(' . $card['rack']->columns . ', 1fr);"'; ?>>
                        <?php $__currentLoopData = $card['grid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            >
                                ...
                                <?php if($cell['occupied']): ?>
                                    <div class="mb-1 text-[10px] font-semibold"><?php echo e($cell['count']); ?>/<?php echo e($cell['capacity']); ?></div>
                                    <div class="flex flex-col gap-0.5 w-full">
                                        ...
                                        <?php if($cell['count'] > 3): ?>
                                            <div class="text-[9px] text-primary-700">+<?php echo e($cell['count'] - 3); ?> buku lainnya</div>
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/data/Smart_LMS/resources/views/racks/index.blade.php ENDPATH**/ ?>