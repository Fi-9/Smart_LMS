                ...
                <section class="hidden lg:block">
                    <div class="max-w-2xl">
                        ...
                        <div class="mt-10 overflow-hidden rounded-[2rem] border border-white/10 bg-white/8 p-4 shadow-2xl shadow-black/20 backdrop-blur-md">
                            <img src="<?php echo e(asset('images/library-login-hero.svg')); ?>" alt="Ilustrasi rak buku dan panel Smart Library" class="w-full rounded-[1.5rem] object-cover">
                        </div>
                    </div>
                </section>
                    ...
                    <div class="login-glow login-card rounded-[2rem] border border-white/60 p-6 sm:p-8 lg:p-10">
                        ...
                        <form method="POST" action="<?php echo e(route('login.store')); ?>" class="space-y-5"
                            ...
                            <div>
                                ...
                                <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username" class="login-input">
                            </div>
...
<?php /**PATH C:\Users\renre\Downloads\Smart_LMS\resources\views/auth/login.blade.php ENDPATH**/ ?>