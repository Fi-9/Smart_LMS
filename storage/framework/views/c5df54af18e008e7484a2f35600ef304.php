...
<?php $component->withAttributes([]); ?>
                <div class="mb-3 flex items-center justify-between">
                    <h2 class="font-bold text-slate-900"><?php echo e($card['rack']->name); ?></h2>
                    <a href="<?php echo e(route('racks.show', $card['rack'])); ?>" class="text-xs font-medium text-blue-600 hover:text-blue-800">Manage Placement</a>
                </div>

                <div class="<?php echo e($card['grid_class']); ?>">
                    <?php $__currentLoopData = $card['grid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="rounded border p-2 text-center text-xs <?php echo e($cell['occupied'] ? 'border-emerald-300 bg-emerald-100 text-emerald-800' : 'border-slate-200 bg-slate-50 text-slate-600'); ?>">
                            <div class="font-semibold"><?php echo e($cell['code']); ?></div>
                            <div class="mt-1 truncate"><?php echo e($cell['book_title'] ?? 'Empty'); ?></div>
                        </div>
